...
> 
> ### Lesson outline
> - Describe the structure of a linear mixed model, the form of the liklihood function, and how fixed/random effects are estimated. Discuss how varience components can be estimated.
> - Familiarize ourselves with the RIKZ data.
> - Perform standard linear regression on the RIKZ data. Check the assumptions of multiple regression, including the indepndence of observations.
