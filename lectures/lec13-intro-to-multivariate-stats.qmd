...
-   Do communities in different habitats–with different structural complexity and environments– have different functional representation in trait space? Could use a [PCA](https://uw.pressbooks.pub/appliedmultivariatestatistics/chapter/pca/), [NMDS](https://uw.pressbooks.pub/appliedmultivariatestatistics/chapter/nmds/), [PCoA](https://uw.pressbooks.pub/appliedmultivariatestatistics/chapter/pcoa/).

## Bird morphology data (Pigot et al. 2020)
...
We will be using the morphology data from Pigot *et al.* (2020), who measured 9 traits (8 morphological, mass) on museum specimens. These traits are previosly known to be important determinants of bird ecomorpholgy. 
...
plot3d(birds$Mass, birds$Beak.Width, birds$Wing.Length, col=alpha("grey80", .01))
points3d(subset(birds, Binomial=="Anthracothorax_mango" | 
                  Binomial=="Harpia_harpyja" |Binomial=="Junco_vulcani")$Mass, 
         subset(birds, Binomial=="Anthracothorax_mango" | 
                  Binomial=="Harpia_harpyja" |Binomial=="Junco_vulcani")$Beak.Width, 
         subset(birds, Binomial=="Anthracothorax_mango" | 
                  Binomial=="Harpia_harpyja" |Binomial=="Junco_vulcani")$Wing.Length, 
         size=10, col=c("darkorange", "darkblue", "#009900"))
```
...
Because we are visualizing this output in a knitted document, we can't add the lines for the other dimensions and have the 3D figure render properly. Instead, I've included the code for how to plot it on your own computer. 
...
1.  Recall the way we started this lecture. We want to know
...
For more details see [this](https://link.springer.com/content/pdf/10.1007/978-1-4419-7976-6.pdf) chapter in Borcard, D., Gillet, F. and Legendre, P. 2011. *Numerical Ecology with R. Chapter 5, page 116*
...
-   [PCA explained using a metaphor with wine, dinner, grandmothers, and animations](https://stats.stackexchange.com/questions/2691/making-sense-of-principal-component-analysis-eigenvectors-eigenvalues)PCoA
-   <https://stirlingcodingclub.github.io/ordination/#wasps> an explanation with math