...
Well, what can we take away from this visualization? Not much. It seems pretty clear that the average LTR is young (darkness at the bottom of the clouds). The few older LTRs near the top of the plots might have useful information for us..

### Discretizing our ages

We can try binning LTRs based on their age, to see if the oldest LTRs were retained in gene-dense regions. Note: don't categorize numerical data like this without considering what information you're losing! 
