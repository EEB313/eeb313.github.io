...
In this case, we can write describe the population size at generation $t+1$ in terms of the _population size at the previous generation_ by keeping track of everything that could unfold.
...
$$N_{1} = (1+b-d) N_0$$
$$N_{2} = (1+b-d) N_1 = (1+b-d)(1+b-d) N_0$$
$$N_{3} = (1+b-d) N_{2} = (1+b-d) (1+b-d)^2 N_0 = (1+b-d)^3 N_0$$
...
subject to $N(0) = N_0$. Like the geometric growth equation, we can solve this equation exactly. Diving through by $N$ and using properties of derivatives from calculus,
...
## Aside: fitting mathematical models to data
...
## A model of mutation-selection balance!
