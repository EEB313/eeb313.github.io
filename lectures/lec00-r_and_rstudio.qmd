# Getting started with RStudio and R Notebook

## Lesson preamble {-}

> ### Lesson objectives
> -   Introduce students to the R and RStudio interfaces
> -   Introduce students to RMarkdown
...
1. Run `R` on the command line. On a Mac, you would do this in the Terminal application. On a Windows machine, you would do this using, e.g., Ubuntu. We will discuss how to use the command line next week.
...
For your first assignment, you will need to write a short description of your interests in EEB and submitted the _knitted_ document on Quercus. This assignment is due September 17. If you are having trouble knitting, which you will have to do throughout the course, come find us and we will help you troubleshoot.