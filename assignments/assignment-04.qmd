...
# 1. Conceptual understanding of probability, random variables, & likelihood (2 mark total)
...
# 2. Simulating random variables (2 marks)
...
# 5. More on likelihood, confidence intervals, and hypothesis testing (1.5 mark)
