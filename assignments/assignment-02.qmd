# Assignment 02: Manipulating and plotting data (8 marks) {-}
...
We will be working with a data set compiled to understand sexual dimorphism in size across mammals. You can download the file from [Dryad](https://datadryad.org/dataset/doi:10.5061/dryad.280gb5mx0) (note: you might have to do this manually, as the site can block R imports) or from the [course website](https://eeb313.github.io/data/SSDinMammals.csv)). The [original study](https://www.nature.com/articles/s41467-024-45739-5#Sec8)[^assignment-02-1] is quite interesting! The Dryad link includes a description of the study variables.
