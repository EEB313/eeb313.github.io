...
The data are available on the course website: [https://eeb313.github.io/](https://eeb313.github.io/lectures/data/satellites.csv){.uri}[lectures](https://eeb313.github.io/assignments/data/crab_satellites.csv){.uri}[/data/satellites.csv](https://eeb313.github.io/lectures/data/satellites.csv){.uri}. Each row is a female, and the variables include female color, spine condition, carapace width (cm), mass (kg), and number of satellite males attached to the female.
