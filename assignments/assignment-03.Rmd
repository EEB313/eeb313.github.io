...
You will apply your data wrangling skills on the yearly change in biomass of plants in the [beautiful Abisko national park in northern Sweden](https://en.wikipedia.org/wiki/Abisko_National_Park). We have preprocessed this data and made it available as a [csv file via this link](https://eeb313.github.io/data/plant-biomass-preprocess.csv). You can find the original data on [Dryad](https://datadryad.org/resource/doi:10.5061/dryad.38s21), and the full-text of the original study[^1] in this [pdf](https://eeb313.github.io/data/plant-biomass-paper.pdf). Reading through the study abstract will increase your understanding for working with the data.
